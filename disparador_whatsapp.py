...
MENSAGENS_PADRAO = [
    "Olá! Vimos que você se conectou ao nosso Wi-Fi 🛜\n\n➡️ Muito prazer! Eu sou a Patrícia Helena, atendente da GENESYS FIBRA 💙\n\nQue tal conversarmos sobre a sua internet? Já é assinante Genesys?\n\n🌟 Todos os nossos planos incluem instalação gratuita e suporte até nos finais de semana 🪜🔧\n\nE tem mais: se você fechar seu contrato, garantimos CONDIÇÕES EXCLUSIVAS e BRINDES ESPECIAIS 🎁✨\n\nEstou por aqui se quiser saber mais!",
    "Olá! Notamos que você utilizou nosso Wi-Fi 🛜\n\n➡️ Prazer! Sou a Patrícia Helena, da GENESYS FIBRA 💙\n\nMe conta: você já é nosso cliente ou está conhecendo agora?\n\n🚀 Nossos planos têm instalação gratuita e suporte até nos finais de semana 🪜🔧\n\nE olha só: fechando com a gente, você garante condições exclusivas + brindes especiais 🎁✨\n\nFico à disposição pra te ajudar!",
    "Olá! Tudo bem? Vimos que você acessou nosso Wi-Fi 🛜\n\n➡️ Eu sou a Patrícia Helena, da GENESYS FIBRA 💙\n\nJá pensou em ter uma internet rápida e estável na sua casa? Você já é cliente nosso?\n\n🌟 Oferecemos instalação gratuita e suporte até nos finais de semana 🪜🔧\n\nE tem benefício extra: assinando agora, você ganha condições exclusivas e brindes especiais 🎁✨\n\nMe chama aqui que te explico tudo!",
    "Oi! Que bom ter você conectado ao nosso Wi-Fi 🛜\n\n➡️ Eu sou a Patrícia Helena, da GENESYS FIBRA 💙\n\nMe diz uma coisa: você já usa nossa internet ou ainda está conhecendo?\n\n💡 Nossos planos incluem instalação grátis e suporte até nos finais de semana 🪜🔧\n\nE se decidir fechar com a gente, ainda rolam condições exclusivas e brindes 🎁✨\n\nSe quiser saber mais, é só falar comigo 😊",
    "Olá! Percebemos que você se conectou ao nosso Wi-Fi 🛜\n\n➡️ Permita-me me apresentar: sou Patrícia Helena, da GENESYS FIBRA 💙\n\nGostaria de saber: você já é nosso assinante ou está conhecendo nossos serviços agora?\n\n✨ Trabalhamos com planos que incluem instalação gratuita e suporte até mesmo aos finais de semana 🪜🔧\n\nAlém disso, ao contratar, você garante condições exclusivas e brindes especiais 🎁\n\nFico à disposição para te atender!",
]
...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        self.duracao_pausa.insert(0, "15")
